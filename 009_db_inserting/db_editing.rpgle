...
dcl-f  PERSON_CH             workstn indDS(DSPFInd);
...
dcl-proc PrcEnter;
  ...
  IF (F0AUGFARBE <> *blank) AND NOT IsAlpha(F0AUGFARBE);
...
// Variablen zuweisen
  ...
  o_PERSON00.AUGENFARBE = F0AUGFARBE;
...
IF NOT ChkPerson(o_PERSON00 : d_ChkPerson : p_RRN); // Wenn Der Logische Check keinen Fehler aufwirft direkt zu Write
